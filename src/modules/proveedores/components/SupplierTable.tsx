...
import { SupplierDetailModal } from "@/modules/proveedores/components/SupplierDetailModal";
    ...
    return (
      <div className="rounded-2xl border border-dashed border-slate-300 bg-white px-6 py-14 text-center">
        ...
        <p className="mt-2 text-sm text-slate-500">
          Ejecuta <code className="rounded bg-slate-100 px-1.5 py-0.5 font-mono text-xs">schema.sql</code> y luego{" "}
          <code className="rounded bg-slate-100 px-1.5 py-0.5 font-mono text-xs">seed.sql</code> en el SQL Editor de Supabase para cargar los datos demo.
        </p>
      </div>
    );
  }
